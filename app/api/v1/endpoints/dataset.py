...
@router.get("", response_model=List[schemas.Dataset], dependencies=[Depends(deps.api_key_auth)])
...
@router.get("/{id}", response_model=schemas.Dataset, dependencies=[Depends(deps.api_key_auth)])
